!(function(e) {
  function r(data) {
    for (
      var r, t, l = data[0], f = data[1], d = data[2], i = 0, h = [];
      i < l.length;
      i++
    )
      (t = l[i]),
        Object.prototype.hasOwnProperty.call(o, t) && o[t] && h.push(o[t][0]),
        (o[t] = 0);
          ...
          (script.src = (function(e) {
            return (
              ...
              ({
                2: "content/plugin.js",
                3: "pages/index",
                6: "vendors~content/plugin.js",
                7: "vendors~pages/index"
              }[e] || e) +
              "." +
              {
                2: "34cddeb",
